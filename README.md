This document provides instructions and guidelines on how to use Autorest.Az to generate the CLI code.  
...
[4. Advanced Features](#Advanced-Features)  
  ...
  [4.2.a. Add Parent Extension](#Add-Parent-Extension)  
  [4.2.b. Set Extension/Command Groups/Commands/Parameters Mode](#Set-Extension/Command-Groups/Commands/Parameters-Mode)   
  [4.2.c. Set min-api/max-api in Command Groups/Commands/Parameters](#Set-min-api/max-api-in-Command-Groups/Commands/Parameters)  
  [4.2.d. Move Command Groups/Command Layer](#Move-Command-Groups/Command-Layer)  
  [4.2.e. Rename/Hide Command Groups/Commands/Parameters](#Rename/Hide-Command-Groups/Commands/Parameters)   
  [4.2.f. Client Factory Customization](#Client-Factory-Customization)  
  [4.2.g. Parameter Specific Customization](#Parameter-Specific-Customization)  
      [4.2.g.i. flatten a parameter](#flatten-a-parameter)  
      [4.2.g.ii. set a parameter as required](#set-a-parameter-as-required)  
      [4.2.g.iii. set default value for a parameter](#set-default-value-for-a-parameter)  
      [4.2.g.iv. add alias for a parameter](#add-alias-for-a-parameter)  
      [4.2.g.v. how an action parameter is handled](#how-an-action-parameter-is-handled)  
      [4.2.g.vi. set an action as positional argument](#set-an-action-as-positional-argument)  
      [4.2.g.vii. set an action as AWS shorthand syntax](#set-an-action-as-AWS-shorthand-syntax)  
[4.3. SDK Customization](#SDK-Customization)  
[4.3.a. Flattened SDK and un-Flattened SDK](#Flattened-SDK-and-un-Flattened-SDK)  
[4.3.b. Track1 SDK and Track2 SDK](#Track1-SDK-and-Track2-SDK)  
