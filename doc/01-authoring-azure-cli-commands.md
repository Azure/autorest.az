...
### Changing Command Group Name

If command group name generated by default is not desired, just add configs like below to **readme.az.md**.

Here is an example change command group name from 'ManagedNetworks' to 'mn'.
~~~
cli:
    cli-directive:
    ...
...
### Rename/Hide Operation

If operation name generated by default is not desired, just add configs like below to **readme.az.md**.

Here is an example rename operation 'ManagedNetworkPeeringPolicies list' to 'ManagedNetworkPeeringPolicies ls'.
~~~
cli:
    cli-directive:
    ...
...
Here is an example hide operation 'check-name-availability' in all command groups.
~~~
cli:
    cli-directive:
    ...
...
If parameter name generated by default is not desired, just add configs like below to **readme.az.md**.

Here is an example rename parameter 'managedNetworkPeeringPolicyName' to 'policy_name'.
~~~
cli:
    cli-directive:
    ...
...
Using 'required' to mark a parameter is mandatory.
