...
export interface CodeModelAz {
    ...
    CustomResourceType: string | undefined;
    ...
    CommandGroup_CustomResourceType: string | undefined;
    ...
    Command_CustomResourceType: string | undefined;
    ...
    Method_CustomResourceType: string | undefined;
