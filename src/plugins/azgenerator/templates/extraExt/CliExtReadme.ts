...
import { CmdToMultiLines } from "../../../../utils/helper";
...
export class CliExtReadme extends TemplateBase {
    ...
    public async fullGeneration(): Promise<string[]> {
        let output: string[] = [];
        let commandParams = this.model.GatherInternalResource();
