...
def load_command_table(self, _):
    ...
    with self.command_group('attestation provider', attestation_attestation_provider,
                            client_factory=cf_attestation_provider, is_experimental=True) as g:
        g.custom_command('list', 'attestation_provider_list')
        ...
        g.custom_command('list-attestation', 'attestation_provider_list_attestation')
