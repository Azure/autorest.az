...
class AddScopeManagementGroups(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddScopeManagementGroups, self).__call__(parser, namespace, action, option_string)
...
class AddScopeSubscriptions(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddScopeSubscriptions, self).__call__(parser, namespace, action, option_string)
...
class AddScopeVirtualNetworks(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddScopeVirtualNetworks, self).__call__(parser, namespace, action, option_string)
...
class AddScopeSubnets(argparse._AppendAction):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        super(AddScopeSubnets, self).__call__(parser, namespace, action, option_string)
