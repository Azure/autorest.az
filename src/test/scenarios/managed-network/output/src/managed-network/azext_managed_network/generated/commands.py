...
def load_command_table(self, _):
    ...
    with self.command_group('managed-network managed-network-peering-policy',
        ...
        g.custom_command('hub-and-spoke-topology update', 'managed_network_managed_network_peering_policy_hub_and_spoke'
                         '_topology_update', supports_no_wait=True)
        g.custom_command('mesh-topology update', 'managed_network_managed_network_peering_policy_mesh_topology_update',
                          supports_no_wait=True)
