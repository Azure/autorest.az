...
def load_command_table(self, _):
    ...
    with self.command_group('managed-network managed-network-peering-policy',
        ...
        g.generic_update_command('mesh-topology update', setter_name='begin_create_or_update', custom_func_name=''
                                 'managed_network_managed_network_peering_policy_mesh_topology_update',
                                 supports_no_wait=True)
