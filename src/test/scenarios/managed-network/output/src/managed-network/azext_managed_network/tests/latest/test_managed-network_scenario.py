...
class ManagedNetworkManagementClientScenarioTest(ScenarioTest):
    ...
    @ResourceGroupPreparer(name_prefix='cli_test_managed_network_myResourceGroup', key='rg_myResourceGroup')
    @VirtualNetworkPreparer(name_prefix='cli_test_managed_network_myHubVnet', key='vn_myHubVnet', resource_group_key='myResourceGroup')
    def test_managed_network(self, resource_group):

        self.cmd('az managed-network scope-assignments create '
                 '--assigned-managed-network "/subscriptions/subscriptionA/resourceGroups/{rg_myResourceGroup}/providers/Microsoft.ManagedNetwork/managedNetworks/myManagedNetwork" '
        ...
        self.cmd('az managed-network managed-networks create '
                 ...
                 '--resource-group "{rg_myResourceGroup}"',
                 checks=[])
        ...
        self.cmd('az managed-network managed-network-peering-policies create '
                 ...
                 '--id "/subscriptions/subscriptionB/resourceGroups/{rg_myResourceGroup}/providers/Microsoft.Network/virtualNetworks/{vn_myHubVnet}" '
                 '--resource-group "{rg_myResourceGroup}"',
                 checks=[])
