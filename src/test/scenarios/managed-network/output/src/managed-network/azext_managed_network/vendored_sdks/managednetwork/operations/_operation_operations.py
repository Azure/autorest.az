...
class OperationOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~managed_network_management_client.models.OperationListResult]
    ...
    list.metadata = {'url': '/providers/Microsoft.ManagedNetwork/operations'}  # type: ignore
