...
class ManagedNetworkPeeringPolicyOperations:
    ...
    async def _create_or_update_hubandspoketopology_initial(
        self,
        resource_group_name: str,
        managed_network_name: str,
        managed_network_peering_policy_name: str,
        hubandspoketopology_type: Union[str, "models.Type"],
        location: Optional[str] = None,
        hubandspoketopology_hub: Optional["models.ResourceId"] = None,
        hubandspoketopology_spokes: Optional[List["ResourceId"]] = None,
        hubandspoketopology_mesh: Optional[List["ResourceId"]] = None,
        **kwargs
    ) -> "models.ManagedNetworkPeeringPolicy":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def create_or_update_hubandspoketopology(
        self,
        resource_group_name: str,
        managed_network_name: str,
        managed_network_peering_policy_name: str,
     ...
     policy.
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        raw_result = await self._create_or_update_hubandspoketopology_initial(
            resource_group_name=resource_group_name,
            managed_network_name=managed_network_name,
            managed_network_peering_policy_name=managed_network_peering_policy_name,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_hubandspoketopology.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}'}

    async def _create_or_update_meshtopology_initial(
        self,
        resource_group_name: str,
        managed_network_name: str,
        managed_network_peering_policy_name: str,
        meshtopology_type: Union[str, "models.Type"],
        location: Optional[str] = None,
        meshtopology_hub: Optional["models.ResourceId"] = None,
        meshtopology_spokes: Optional[List["ResourceId"]] = None,
        meshtopology_mesh: Optional[List["ResourceId"]] = None,
        **kwargs
    ) -> "models.ManagedNetworkPeeringPolicy":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def create_or_update_meshtopology(
        self,
        resource_group_name: str,
        managed_network_name: str,
        managed_network_peering_policy_name: str,
        ...
        **kwargs
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        raw_result = await self._create_or_update_meshtopology_initial(
            resource_group_name=resource_group_name,
            managed_network_name=managed_network_name,
            managed_network_peering_policy_name=managed_network_peering_policy_name,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_meshtopology.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}'}
