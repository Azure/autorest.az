...
class ManagedNetworkPeeringPolicyOperations(object):
    ...
    def _create_or_update_hubandspoketopology_initial(
        self,
        resource_group_name,  # type: str
        managed_network_name,  # type: str
        managed_network_peering_policy_name,  # type: str
        hubandspoketopology_type,  # type: Union[str, "models.Type"]
        location=None,  # type: Optional[str]
        hubandspoketopology_hub=None,  # type: Optional["models.ResourceId"]
        hubandspoketopology_spokes=None,  # type: Optional[List["ResourceId"]]
        hubandspoketopology_mesh=None,  # type: Optional[List["ResourceId"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ManagedNetworkPeeringPolicy"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        ...
        _managed_network_policy = models.ManagedNetworkPeeringPolicy(location=location, properties=properties, type=hubandspoketopology_type, hub=hubandspoketopology_hub, spokes=hubandspoketopology_spokes, mesh=hubandspoketopology_mesh)
        api_version = "2019-06-01-preview"
        content_type = kwargs.pop("content_type", "application/json")

        # Construct URL
        url = self._create_or_update_hubandspoketopology_initial.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'managedNetworkName': self._serialize.url("managed_network_name", managed_network_name, 'str'),
        ...
        return deserialized
    _create_or_update_hubandspoketopology_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}'}

    def begin_create_or_update_hubandspoketopology(
        self,
        resource_group_name,  # type: str
        managed_network_name,  # type: str
        managed_network_peering_policy_name,  # type: str
        ...
        **kwargs  # type: Any
        ...
        :param managed_network_peering_policy_name: The name of the Managed Network Peering Policy.
        :type managed_network_peering_policy_name: str
        :param hubandspoketopology_type: Gets or sets the connectivity type of a network structure
     policy.
        :type hubandspoketopology_type: str or ~managed_network_management_client.models.Type
        :param location: The geo-location where the resource lives.
        :type location: str
        :param hubandspoketopology_hub: Gets or sets the hub virtual network ID.
        :type hubandspoketopology_hub: ~managed_network_management_client.models.ResourceId
        :param hubandspoketopology_spokes: Gets or sets the spokes group IDs.
        :type hubandspoketopology_spokes: list[~managed_network_management_client.models.ResourceId]
        :param hubandspoketopology_mesh: Gets or sets the mesh group IDs.
        :type hubandspoketopology_mesh: list[~managed_network_management_client.models.ResourceId]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        raw_result = self._create_or_update_hubandspoketopology_initial(
            resource_group_name=resource_group_name,
            managed_network_name=managed_network_name,
            managed_network_peering_policy_name=managed_network_peering_policy_name,
            hubandspoketopology_type=hubandspoketopology_type,
            location=location,
            hubandspoketopology_hub=hubandspoketopology_hub,
            hubandspoketopology_spokes=hubandspoketopology_spokes,
            hubandspoketopology_mesh=hubandspoketopology_mesh,
            cls=lambda x,y,z: x,
            **kwargs
        )
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update_hubandspoketopology.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}'}

    def _create_or_update_meshtopology_initial(
        self,
        resource_group_name,  # type: str
        managed_network_name,  # type: str
        managed_network_peering_policy_name,  # type: str
        meshtopology_type,  # type: Union[str, "models.Type"]
        location=None,  # type: Optional[str]
        meshtopology_hub=None,  # type: Optional["models.ResourceId"]
        meshtopology_spokes=None,  # type: Optional[List["ResourceId"]]
        meshtopology_mesh=None,  # type: Optional[List["ResourceId"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ManagedNetworkPeeringPolicy"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        ...
        _managed_network_policy = models.ManagedNetworkPeeringPolicy(location=location, properties=properties, type=meshtopology_type, hub=meshtopology_hub, spokes=meshtopology_spokes, mesh=meshtopology_mesh)
        api_version = "2019-06-01-preview"
        content_type = kwargs.pop("content_type", "application/json")

        # Construct URL
        url = self._create_or_update_meshtopology_initial.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'managedNetworkName': self._serialize.url("managed_network_name", managed_network_name, 'str'),
        ...
        return deserialized
    _create_or_update_meshtopology_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}'}

    def begin_create_or_update_meshtopology(
        self,
        resource_group_name,  # type: str
        managed_network_name,  # type: str
        managed_network_peering_policy_name,  # type: str
        ...
        **kwargs  # type: Any
        ...
        :param managed_network_peering_policy_name: The name of the Managed Network Peering Policy.
        :type managed_network_peering_policy_name: str
        :param meshtopology_type: Gets or sets the connectivity type of a network structure policy.
        :type meshtopology_type: str or ~managed_network_management_client.models.Type
        :param location: The geo-location where the resource lives.
        :type location: str
        :param meshtopology_hub: Gets or sets the hub virtual network ID.
        :type meshtopology_hub: ~managed_network_management_client.models.ResourceId
        :param meshtopology_spokes: Gets or sets the spokes group IDs.
        :type meshtopology_spokes: list[~managed_network_management_client.models.ResourceId]
        :param meshtopology_mesh: Gets or sets the mesh group IDs.
        :type meshtopology_mesh: list[~managed_network_management_client.models.ResourceId]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedNetworkPeeringPolicy"]
        raw_result = self._create_or_update_meshtopology_initial(
            resource_group_name=resource_group_name,
            managed_network_name=managed_network_name,
            managed_network_peering_policy_name=managed_network_peering_policy_name,
            meshtopology_type=meshtopology_type,
            location=location,
            meshtopology_hub=meshtopology_hub,
            meshtopology_spokes=meshtopology_spokes,
            meshtopology_mesh=meshtopology_mesh,
            cls=lambda x,y,z: x,
            **kwargs
        )
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update_meshtopology.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}'}
