...
def load_command_table(self, _):
    ...
    mixed_reality_spatial_anchor_account = CliCommandType(
        operations_tmpl='azext_mixed_reality.vendored_sdks.mixedreality.operations#SpatialAnchorAccountOperations.{}',
    ...
    mixed_reality_remote_rendering_account = CliCommandType(
        operations_tmpl='azext_mixed_reality.vendored_sdks.mixedreality.operations#RemoteRenderingAccountOperations.{}',
