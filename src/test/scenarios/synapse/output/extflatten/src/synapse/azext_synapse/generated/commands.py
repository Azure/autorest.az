...
def load_command_table(self, _):
    ...
    synapse_ip_firewall_rule = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._ip_firewall_rule_operations#IpFirewallRuleOper'
        'ations.{}',
    ...
    synapse_sqlpool_metadata_sync_config = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_metadata_sync_config_operations#SQLPo'
        'olMetadataSyncConfigOperations.{}',
    ...
    synapse_sqlpool_operation_result = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_operation_result_operations#SQLPoolOp'
        'erationResultOperations.{}',
    ...
    synapse_sqlpool_geo_backup_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_geo_backup_policy_operations#SQLPoolG'
        'eoBackupPolicyOperations.{}',
    ...
    synapse_sqlpool_data_warehouse_user_activity = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_data_warehouse_user_activity_operatio'
        'ns#SQLPoolDataWarehouseUserActivityOperations.{}',
    ...
    synapse_sqlpool_restore_point = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_restore_point_operations#SQLPoolResto'
        'rePointOperations.{}',
    ...
    synapse_sqlpool_replication_link = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_replication_link_operations#SQLPoolRe'
        'plicationLinkOperations.{}',
    ...
    synapse_sqlpool_transparent_data_encryption = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_transparent_data_encryption_operation'
        's#SQLPoolTransparentDataEncryptionOperations.{}',
    ...
    synapse_sqlpool_blob_auditing_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_blob_auditing_policy_operations#SQLPo'
        'olBlobAuditingPolicyOperations.{}',
    ...
    synapse_sqlpool_operation = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_operation_operations#SQLPoolOperation'
        'Operations.{}',
    ...
    synapse_sqlpool_usage = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_usage_operations#SQLPoolUsageOperatio'
        'ns.{}',
    ...
    synapse_sqlpool_sensitivity_label = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_sensitivity_label_operations#SQLPoolS'
        'ensitivityLabelOperations.{}',
    ...
    synapse_sqlpool_schema = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_schema_operations#SQLPoolSchemaOperat'
        'ions.{}',
    ...
    synapse_sqlpool_table = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_table_operations#SQLPoolTableOperatio'
        'ns.{}',
    ...
    synapse_sqlpool_table_column = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_table_column_operations#SQLPoolTableC'
        'olumnOperations.{}',
    ...
    synapse_sqlpool_connection_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_connection_policy_operations#SQLPoolC'
        'onnectionPolicyOperations.{}',
    ...
    synapse_sqlpool_vulnerability_assessment = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_vulnerability_assessment_operations#S'
        'QLPoolVulnerabilityAssessmentOperations.{}',
    ...
    synapse_sqlpool_vulnerability_assessment_scan = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_vulnerability_assessment_scan_operati'
        'ons#SQLPoolVulnerabilityAssessmentScanOperations.{}',
    ...
    synapse_sqlpool_security_alert_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_security_alert_policy_operations#SQLP'
        'oolSecurityAlertPolicyOperations.{}',
    ...
    synapse_sqlpool_vulnerability_assessment_rule_baseline = CliCommandType(
        ...
        'e_operations#SQLPoolVulnerabilityAssessmentRuleBaselineOperations.{}',
    ...
    synapse_workspace_aadadmin = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._workspace_aad_admin_operations#WorkspaceAADAdm'
        'inOperations.{}',
    ...
    synapse_workspace_managed_identity_sqlcontrol_setting = CliCommandType(
        ...
        '_operations#WorkspaceManagedIdentitySQLControlSettingOperations.{}',
    ...
    synapse_integration_runtime = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_operations#IntegrationRunt'
        'imeOperations.{}',
    ...
    synapse_integration_runtime_node = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_node_operations#Integratio'
        'nRuntimeNodeOperations.{}',
    ...
    synapse_integration_runtime_connection_info = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_connection_info_operations'
    ...
    synapse_integration_runtime_auth_key = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_auth_key_operations#Integr'
        'ationRuntimeAuthKeyOperations.{}',
    ...
    synapse_private_link_resource = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._private_link_resource_operations#PrivateLinkRe'
        'sourceOperations.{}',
    ...
    synapse_private_endpoint_connection = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._private_endpoint_connection_operations#Private'
        'EndpointConnectionOperations.{}',
    ...
    synapse_private_link_hub = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._private_link_hub_operations#PrivateLinkHubOper'
        'ations.{}',
