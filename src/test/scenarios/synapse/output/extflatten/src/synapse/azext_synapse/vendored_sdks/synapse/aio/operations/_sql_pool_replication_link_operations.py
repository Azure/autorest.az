...
class SQLPoolReplicationLinkOperations:
    """SQLPoolReplicationLinkOperations async operations.
    ...
    def list(
        ...
        sql_pool_name: str,
        **kwargs
    ) -> AsyncIterable["models.ReplicationLinkListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~synapse_management_client.models.ReplicationLinkListResult]
