...
class SQLPoolGeoBackupPolicyOperations(object):
    """SQLPoolGeoBackupPolicyOperations operations.
    ...
    def get(
        ...
        geo_backup_policy_name,  # type: Union[str, "models.GeoBackupPolicyName"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.GeoBackupPolicy"
        ...
        :type geo_backup_policy_name: str or ~synapse_management_client.models.GeoBackupPolicyName
