...
class SQLPoolUsageOperations(object):
    """SQLPoolUsageOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.SQLPoolUsageListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~synapse_management_client.models.SQLPoolUsageListResult]
