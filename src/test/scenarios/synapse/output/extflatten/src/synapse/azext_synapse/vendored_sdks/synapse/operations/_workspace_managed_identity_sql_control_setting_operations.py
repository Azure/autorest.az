...
class WorkspaceManagedIdentitySQLControlSettingOperations(object):
    """WorkspaceManagedIdentitySQLControlSettingOperations operations.
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ManagedIdentitySQLControlSettingsModel"
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        desired_state=None,  # type: Optional[Union[str, "models.ManagedIdentitySQLControlSettingsModelPropertiesGrantSQLControlToManagedIdentityDesiredState"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ManagedIdentitySQLControlSettingsModel"
        ...
        :type desired_state: str or ~synapse_management_client.models.ManagedIdentitySQLControlSettingsModelPropertiesGrantSQLControlToManagedIdentityDesiredState
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagedIdentitySQLControlSettingsModel, or the result of cls(response)
        :rtype: ~synapse_management_client.models.ManagedIdentitySQLControlSettingsModel
        :raises: ~azure.core.exceptions.HttpResponseError
