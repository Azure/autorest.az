...
class Operations(object):
    ...
    def check_name_availability(
        self,
        request,  # type: "models.CheckNameAvailabilityRequest"
        **kwargs  # type: Any
    ):
        ...
        :type request: ~synapse_management_client.models.CheckNameAvailabilityRequest
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> List["models.AvailableRpOperation"]
        """All operations.
    ...
    def get_azure_async_header_result(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional[Union["models.OperationResource", "models.ErrorContract"]]
        ...
        :type operation_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OperationResource or ErrorContract, or the result of cls(response)
        ...
        if response.status_code == 500:
            deserialized = self._deserialize('ErrorContract', pipeline_response)
