...
class WorkspaceManagedIdentitySqlControlSettingsOperations(object):
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        managed_identity_sql_control_settings,  # type: "models.ManagedIdentitySqlControlSettingsModel"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ManagedIdentitySqlControlSettingsModel"
        ...
        :type managed_identity_sql_control_settings: ~synapse_management_client.models.ManagedIdentitySqlControlSettingsModel
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagedIdentitySqlControlSettingsModel, or the result of cls(response)
        :rtype: ~synapse_management_client.models.ManagedIdentitySqlControlSettingsModel
        :raises: ~azure.core.exceptions.HttpResponseError
