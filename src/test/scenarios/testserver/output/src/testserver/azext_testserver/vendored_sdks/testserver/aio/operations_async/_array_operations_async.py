...
class ArrayOperations:
    ...
    async def get_enum_valid(
        ...
        **kwargs
        ...
        :rtype: list[str or ~auto_rest_test_service.models.FooEnum]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_enum_valid(
        ...
        **kwargs
        ...
        :param array_body:
        :type array_body: list[str or ~auto_rest_test_service.models.FooEnum]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_string_enum_valid(
        ...
        **kwargs
        ...
        :rtype: list[str or ~auto_rest_test_service.models.Enum0]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_string_enum_valid(
        ...
        **kwargs
        ...
        :param array_body:
        :type array_body: list[str or ~auto_rest_test_service.models.Enum1]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_uuid_invalid_char(
        self,
        **kwargs
    ) -> List[str]:
        ...
        # Construct URL
        url = self.get_uuid_invalid_char.metadata['url']  # type: ignore
        ...
        return deserialized
    get_uuid_invalid_char.metadata = {'url': '/array/prim/uuid/invalidchars'}  # type: ignore
    ...
    async def get_date_invalid_char(
        self,
        **kwargs
    ) -> List[datetime.date]:
        ...
        # Construct URL
        url = self.get_date_invalid_char.metadata['url']  # type: ignore
        ...
        return deserialized
    get_date_invalid_char.metadata = {'url': '/array/prim/date/invalidchars'}  # type: ignore
    ...
    async def get_date_time_invalid_char(
        self,
        **kwargs
    ) -> List[datetime.datetime]:
        ...
        # Construct URL
        url = self.get_date_time_invalid_char.metadata['url']  # type: ignore
        ...
        return deserialized
    get_date_time_invalid_char.metadata = {'url': '/array/prim/date-time/invalidchars'}  # type: ignore
    ...
    async def get_complex_null(
        ...
        **kwargs
        ...
        :rtype: list[~auto_rest_test_service.models.Product]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def put_complex_valid(
        ...
        **kwargs
        ...
        :param array_body:
        :type array_body: list[~auto_rest_test_service.models.Product]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
