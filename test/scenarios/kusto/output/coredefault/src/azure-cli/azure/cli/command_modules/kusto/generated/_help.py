...
helps['kusto data-connection create'] = """
    ...
    parameters:
      - name: --event-hub-data-connection
        short-summary: "Class representing an event hub data connection."
        long-summary: |
            Usage: --event-hub-data-connection event-hub-resource-id=XX consumer-group=XX table-name=XX \
mapping-rule-name=XX data-format=XX event-system-properties=XX compression=XX location=XX kind=XX

            event-hub-resource-id: The resource ID of the event hub to be used to create a data connection.
            consumer-group: The event hub consumer group.
            table-name: The table where the data should be ingested. Optionally the table information can be added to \
each message.
            mapping-rule-name: The mapping rule to be used to ingest the data. Optionally the mapping information can \
be added to each message.
            data-format: The data format of the message. Optionally the data format can be added to each message.
            event-system-properties: System properties of the event hub
            compression: The event hub messages compression type
            location: Resource location.
            kind: Required. Kind of the endpoint for the data connection
      - name: --iot-hub-data-connection
        short-summary: "Class representing an iot hub data connection."
        long-summary: |
            Usage: --iot-hub-data-connection iot-hub-resource-id=XX consumer-group=XX table-name=XX \
mapping-rule-name=XX data-format=XX event-system-properties=XX shared-access-policy-name=XX location=XX kind=XX

            iot-hub-resource-id: The resource ID of the Iot hub to be used to create a data connection.
            consumer-group: The iot hub consumer group.
            table-name: The table where the data should be ingested. Optionally the table information can be added to \
each message.
            mapping-rule-name: The mapping rule to be used to ingest the data. Optionally the mapping information can \
be added to each message.
            data-format: The data format of the message. Optionally the data format can be added to each message.
            event-system-properties: System properties of the iot hub
            shared-access-policy-name: The name of the share access policy
            location: Resource location.
            kind: Required. Kind of the endpoint for the data connection
      - name: --event-grid-data-connection
        short-summary: "Class representing an Event Grid data connection."
        long-summary: |
            Usage: --event-grid-data-connection storage-account-resource-id=XX event-hub-resource-id=XX \
consumer-group=XX table-name=XX mapping-rule-name=XX data-format=XX ignore-first-record=XX blob-storage-event-type=XX \
location=XX kind=XX

            storage-account-resource-id: The resource ID of the storage account where the data resides.
            event-hub-resource-id: The resource ID where the event grid is configured to send events.
            consumer-group: The event hub consumer group.
            table-name: The table where the data should be ingested. Optionally the table information can be added to \
each message.
            mapping-rule-name: The mapping rule to be used to ingest the data. Optionally the mapping information can \
be added to each message.
            data-format: The data format of the message. Optionally the data format can be added to each message.
            ignore-first-record: A Boolean value that, if set to true, indicates that ingestion should ignore the \
first record of every file
            blob-storage-event-type: The name of blob storage event type to process.
            location: Resource location.
            kind: Required. Kind of the endpoint for the data connection
    examples:
      - name: KustoDataConnectionsCreateOrUpdate
        text: |-
               az kusto data-connection create --cluster-name "kustoclusterrptest4" --name "DataConnections8" \
--database-name "KustoDatabase8" --event-hub-data-connection location="westus" event-hub-resource-id="/subscriptions/12\
345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.EventHub/namespaces/eventhubTestns1/e\
venthubs/eventhubTest1" consumer-group="testConsumerGroup1" --resource-group "kustorptest"
"""
...
first record of every file
    ...
    examples:
      - name: KustoDataConnectionsUpdate
        text: |-
               az kusto data-connection update --cluster-name "kustoclusterrptest4" --name "DataConnections8" \
--database-name "KustoDatabase8" --event-hub-data-connection location="westus" event-hub-resource-id="/subscriptions/12\
345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.EventHub/namespaces/eventhubTestns1/e\
venthubs/eventhubTest1" consumer-group="testConsumerGroup1" --resource-group "kustorptest"
"""
...
--database-name "KustoDatabase8" --name "DataConnections8" --event-hub-data-connection consumer-group="testConsumerGrou\
p1" event-hub-resource-id="/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Mic\
rosoft.EventHub/namespaces/eventhubTestns1/eventhubs/eventhubTest1" --resource-group "kustorptest"
"""
...
--database-name "KustoDatabase8" --resource-group "kustorptest" --created
      - name: Pause executing next line of CLI script until the kusto data-connection is successfully updated.
        text: |-
               az kusto data-connection wait --cluster-name "kustoclusterrptest4" --name "DataConnections8" \
--database-name "KustoDatabase8" --resource-group "kustorptest" --updated
