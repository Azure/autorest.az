...
class ManagedNetworkPeeringPoliciesOperations:
    ...
    async def get(
        ...
        **kwargs
    ) -> "_models.ManagedNetworkPeeringPolicy":
    ...
    async def _create_or_update_initial(
        ...
        managed_network_name: str,
        managed_network_peering_policy_name: str,
        managed_network_policy: "_models.ManagedNetworkPeeringPolicy",
        **kwargs
    ) -> "_models.ManagedNetworkPeeringPolicy":
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ManagedNetworkPeeringPolicy"]
        error_map = {
    ...
    async def begin_create_or_update(
        ...
        managed_network_policy: "_models.ManagedNetworkPeeringPolicy",
        **kwargs
    ) -> AsyncLROPoller["_models.ManagedNetworkPeeringPolicy"]:
    ...
    def list_by_managed_network(
        ...
        **kwargs
    ) -> AsyncIterable["_models.ManagedNetworkPeeringPolicyListResult"]:
