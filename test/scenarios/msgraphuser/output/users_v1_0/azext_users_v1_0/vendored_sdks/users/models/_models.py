...
class MicrosoftGraphCalendar(MicrosoftGraphEntity):
    ...
    :type change_key: str
    :param color: calendarColor. Possible values include: "lightBlue", "lightGreen", "auto",
     "lightOrange", "lightGray", "lightYellow", "lightTeal", "lightPink", "lightBrown", "lightRed",
     "maxColor".
...
class MicrosoftGraphDeviceCompliancePolicyState(MicrosoftGraphEntity):
    ...
    :type display_name: str
    :param platform_type: policyPlatformType. Possible values include: "android", "iOS", "macOS",
     "windowsPhone81", "windows81AndLater", "windows10AndLater", "androidWorkProfile", "all".
...
class MicrosoftGraphEvent(MicrosoftGraphOutlookItem):
    ...
    :param show_as: freeBusyStatus. Possible values include: "free", "tentative", "unknown",
...
class MicrosoftGraphNotebook(MicrosoftGraphOnenoteEntityHierarchyModel):
    ...
    :param user_role: onenoteUserRole. Possible values include: "Owner", "Contributor", "None",
     "Reader".
...
class MicrosoftGraphOutlookCategory(MicrosoftGraphEntity):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :param color: categoryColor. Possible values include: "preset0", "preset1", "none", "preset2",
     ...
     "preset19", "preset20", "preset21", "preset22", "preset23", "preset24".
...
class MicrosoftGraphScoredEmailAddress(msrest.serialization.Model):
    ...
    :param selection_likelihood: selectionLikelihoodInfo. Possible values include: "notSpecified",
     "high".
...
class MicrosoftGraphWorkbookOperation(MicrosoftGraphEntity):
    ...
    :type resource_location: str
    :param status: workbookOperationStatus. Possible values include: "notStarted", "running",
     "succeeded", "failed".
