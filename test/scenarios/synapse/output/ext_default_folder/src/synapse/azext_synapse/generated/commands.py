...
def load_command_table(self, _):
    ...
    synapse_big_data_pool = CliCommandType(
        operations_tmpl=(
            'azext_synapse.vendored_sdks.synapse.operations._big_data_pools_operations#BigDataPoolsOperations.{}'
        ),
    ...
    synapse_ip_firewall_rule = CliCommandType(
        operations_tmpl=(
            'azext_synapse.vendored_sdks.synapse.operations._ip_firewall_rules_operations#IpFirewallRulesOperations.{}'
        ),
    ...
    with self.command_group(
        ...
        g.generic_update_command(
            ...
            custom_func_name='synapse_ip_firewall_rule_update',
            setter_arg_name='ip_firewall_rule_info',
    ...
    synapse_sqlpool_metadata_sync_config = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_metadata_sync_configs_operations#SqlPoolMetadataSyncConfigsOperations.{}',
    ...
    synapse_sqlpool_operation_result = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_operation_results_operations#SqlPoolOperationResultsOperations.{}',
    ...
    synapse_sqlpool_geo_backup_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_geo_backup_policies_operations#SqlPoolGeoBackupPoliciesOperations.{}',
    ...
    synapse_sqlpool_data_warehouse_user_activity = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_data_warehouse_user_activities_operations#SqlPoolDataWarehouseUserActivitiesOperations.{}',
    ...
    synapse_sqlpool_restore_point = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_restore_points_operations#SqlPoolRestorePointsOperations.{}',
    ...
    synapse_sqlpool_replication_link = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_replication_links_operations#SqlPoolReplicationLinksOperations.{}',
    ...
    synapse_sqlpool_transparent_data_encryption = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_transparent_data_encryptions_operations#SqlPoolTransparentDataEncryptionsOperations.{}',
    ...
    synapse_sqlpool_blob_auditing_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_blob_auditing_policies_operations#SqlPoolBlobAuditingPoliciesOperations.{}',
    ...
    synapse_sqlpool_operation = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_operations_operations#SqlPoolOperationsOperations.{}',
    ...
    synapse_sqlpool_usage = CliCommandType(
        operations_tmpl=(
            'azext_synapse.vendored_sdks.synapse.operations._sql_pool_usages_operations#SqlPoolUsagesOperations.{}'
        ),
    ...
    synapse_sqlpool_sensitivity_label = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_sensitivity_labels_operations#SqlPoolSensitivityLabelsOperations.{}',
    ...
    synapse_sqlpool_schema = CliCommandType(
        operations_tmpl=(
            'azext_synapse.vendored_sdks.synapse.operations._sql_pool_schemas_operations#SqlPoolSchemasOperations.{}'
        ),
    ...
    synapse_sqlpool_table = CliCommandType(
        operations_tmpl=(
            'azext_synapse.vendored_sdks.synapse.operations._sql_pool_tables_operations#SqlPoolTablesOperations.{}'
        ),
    ...
    synapse_sqlpool_table_column = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_table_columns_operations#SqlPoolTableColumnsOperations.{}',
    ...
    synapse_sqlpool_connection_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_connection_policies_operations#SqlPoolConnectionPoliciesOperations.{}',
    ...
    synapse_sqlpool_vulnerability_assessment = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_vulnerability_assessments_operations#SqlPoolVulnerabilityAssessmentsOperations.{}',
    ...
    synapse_sqlpool_vulnerability_assessment_scan = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_vulnerability_assessment_scans_operations#SqlPoolVulnerabilityAssessmentScansOperations.{}',
    ...
    synapse_sqlpool_security_alert_policy = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_security_alert_policies_operations#SqlPoolSecurityAlertPoliciesOperations.{}',
    ...
    synapse_sqlpool_vulnerability_assessment_rule_baseline = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._sql_pool_vulnerability_assessment_rule_baselines_operations#SqlPoolVulnerabilityAssessmentRuleBaselinesOperations.{}',
    ...
    synapse_workspace_aadadmin = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._workspace_aad_admins_operations#WorkspaceAadAdminsOperations.{}',
    ...
    synapse_workspace_managed_identity_sqlcontrol_setting = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._workspace_managed_identity_sql_control_settings_operations#WorkspaceManagedIdentitySqlControlSettingsOperations.{}',
    ...
    with self.command_group(
        ...
        g.generic_update_command(
            ...
            setter_arg_name='managed_identity_sql_control_settings',
        )

    from azext_synapse.generated._client_factory import cf_integration_runtime

    synapse_integration_runtime = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtimes_operations#IntegrationRuntimesOperations.{}',
    ...
    synapse_integration_runtime_node = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_nodes_operations#IntegrationRuntimeNodesOperations.{}',
    ...
    synapse_integration_runtime_connection_info = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_connection_infos_operations#IntegrationRuntimeConnectionInfosOperations.{}',
    ...
    synapse_integration_runtime_auth_key = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._integration_runtime_auth_keys_operations#IntegrationRuntimeAuthKeysOperations.{}',
    ...
    synapse_private_link_resource = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._private_link_resources_operations#PrivateLinkResourcesOperations.{}',
    ...
    synapse_private_endpoint_connection = CliCommandType(
        operations_tmpl='azext_synapse.vendored_sdks.synapse.operations._private_endpoint_connections_operations#PrivateEndpointConnectionsOperations.{}',
    ...
    synapse_private_link_hub = CliCommandType(
        operations_tmpl=(
            'azext_synapse.vendored_sdks.synapse.operations._private_link_hubs_operations#PrivateLinkHubsOperations.{}'
        ),
