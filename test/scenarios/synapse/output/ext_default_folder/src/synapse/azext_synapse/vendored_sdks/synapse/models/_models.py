...
class ManagedIdentitySqlControlSettingsModel(ProxyResource):
    ...
    :type grant_sql_control_to_managed_identity:
     ~synapse_management_client.models.ManagedIdentitySqlControlSettingsModelPropertiesGrantSqlControlToManagedIdentity
    """
...
class Workspace(TrackedResource):
    ...
    :type identity: ~synapse_management_client.models.ManagedIdentity
    ...
    :type virtual_network_profile: ~synapse_management_client.models.VirtualNetworkProfile
