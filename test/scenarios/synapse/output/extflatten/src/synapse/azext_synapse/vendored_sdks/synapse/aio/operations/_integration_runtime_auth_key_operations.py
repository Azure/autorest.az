...
class IntegrationRuntimeAuthKeyOperations:
    """IntegrationRuntimeAuthKeyOperations async operations.
    ...
    async def regenerate(
        ...
        key_name: Optional[Union[str, "_models.IntegrationRuntimeAuthKeyName"]] = None,
        **kwargs
