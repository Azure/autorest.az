...
class SQLPoolSensitivityLabelOperations:
    """SQLPoolSensitivityLabelOperations async operations.
    ...
    def list_current(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~synapse_management_client.models.SensitivityLabelListResult]
