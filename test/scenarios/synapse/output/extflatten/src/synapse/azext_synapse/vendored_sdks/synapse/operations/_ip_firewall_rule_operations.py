...
class IpFirewallRuleOperations(object):
    """IpFirewallRuleOperations operations.
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~synapse_management_client.models.IpFirewallRuleInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _replace_all_initial(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        ip_firewall_rules=None,  # type: Optional[Dict[str, "_models.IpFirewallRuleProperties"]]
        **kwargs  # type: Any
    ):
    ...
    def begin_replace_all(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~synapse_management_client.models.ReplaceAllFirewallRulesOperationResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
