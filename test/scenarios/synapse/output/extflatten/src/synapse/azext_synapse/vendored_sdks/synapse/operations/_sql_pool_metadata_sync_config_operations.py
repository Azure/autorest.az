...
class SQLPoolMetadataSyncConfigOperations(object):
    """SQLPoolMetadataSyncConfigOperations operations.
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        metadata_sync_configuration = _models.MetadataSyncConfig(enabled=enabled)
        api_version = "2019-06-01-preview"
