...
class SQLPoolReplicationLinkOperations(object):
    """SQLPoolReplicationLinkOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~synapse_management_client.models.ReplicationLinkListResult]
