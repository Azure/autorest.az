...
class SQLPoolSensitivityLabelOperations(object):
    """SQLPoolSensitivityLabelOperations operations.
    ...
    def create_or_update(
        ...
        label_name=None,  # type: Optional[str]
        label_id=None,  # type: Optional[str]
        information_type=None,  # type: Optional[str]
        information_type_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        parameters = _models.SensitivityLabel(label_name=label_name, label_id=label_id, information_type=information_type, information_type_id=information_type_id)
        api_version = "2019-06-01-preview"
