...
def load_command_table(self, _):
    ...
    with self.command_group('datafactory factory', datafactory_factory, is_experimental=True) as g:
    ...
    with self.command_group('datafactory integration-runtime', datafactory_integration_runtime, is_experimental=True) as g:
        ...
        g.custom_command('linked-integration-runtime create', 'datafactory_integration_runtime_linked_integration_runtime_create')
    ...
    with self.command_group('datafactory linked-service', datafactory_linked_service, is_experimental=True) as g:
        ...
        g.generic_update_command('update', setter_arg_name='properties', custom_func_name='datafactory_linked_service_update')
