...
def load_command_table(self, _):
    ...
    with self.command_group('datafactory', datafactory_factory
    ...
    with self.command_group('datafactory trigger', datafactory_trigger
    ...
    with self.command_group('datafactory group', datafactory_group
